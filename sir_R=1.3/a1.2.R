...
#~ 	X11()
	...
	matplot( times , nes, type = 'l' , log = '', lty=1, add=FALSE, main = ns[k],  ylim = c(1, max(nes ) ) , xlim = c( 0, 25 ), col = 'black', lwd = .5
...
{
#~ X11()
with( sim, plot( t, I , log = '', type = 'l', lty=1, col='red', xlim = c( 0, 25 ),
...
svg( 'a1_2_spagh.svg' , width = 6, height = 5.5)
par(mfrow = c(2,2))
pl2(2) 
pl2(1) 
simpl2() 
